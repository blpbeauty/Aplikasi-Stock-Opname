                  ...
                  >
                    <span className="flex items-center gap-3 min-w-0">
                      ...
                      <span className="min-w-0">
                        <span className="block text-meta font-bold text-text-primary uppercase break-all tnum">
                          {item.location}
                        </span>
            ...
            {pendingLocations.map((loc) => (
              <li key={loc.locationCode} className="flex items-center justify-between gap-2 py-2.5">
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-meta font-bold text-text-primary uppercase break-all leading-snug tnum">
                      {loc.locationCode}
                    </p>
